...
<div class="swiper-slide">
        ...
        <div class="py-4 px-4 flex flex-col items-start justify-between relative">
            ...
            <div class="relative w-full h-6 mt-1 z-10">
                ...
                <div class="flex items-center gap-3 text-[14px] font-semibold absolute top-0 left-0 text-gray-600">
                    <button
                        class="select-options-btn transition-all duration-300 opacity-0 translate-y-full
                                                group-hover:opacity-100 group-hover:translate-y-0 group-hover:delay-[0ms] delay-[200ms]">
                        SELECT&nbsp;OPTIONS
                    </button>
                    <button class="open-quickview-btn border-b-2 border-black text-md transition-all duration-300
                                                opacity-0 translate-y-full group-hover:opacity-100
                                                group-hover:translate-y-0 group-hover:delay-[100ms] delay-[200ms]" data-product-id="1"
                        data-product-name="Default Product Name" data-product-price="999.00"
                        data-product-image="{{ asset('images/1.webp') }}" data-product-sizes='["S", "M", "L", "XL"]'>
                        QUICKVIEW
                    </button>



                    <button class="wishlist-button transition-all duration-300
                                                opacity-0 translate-y-full group-hover:opacity-100
                                                group-hover:translate-y-0 group-hover:delay-[150ms] delay-[200ms]" data-id="1" data-name="Stripe Polo T-Shirt" data-price="1150"
            ...
            <div id="product-opction" class="product-options-modal absolute left-0 w-full bg-white p-4 shadow-xl rounded-lg z-[9999] border hidden"
                ...
                <div class="mb-4">
                    <div class="relative mt-1">
                        <select
                            class="product-size-select block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md appearance-none">
                ...
                <div class="flex items-center space-x-1 xl:space-x-3 mb-4">
                    ...
                    <button
                        class="add-to-cart-btn bg-gray-800 text-gray-400 font-semibold px-5 py-2.5 rounded hover:bg-gray-800 transition-colors"
                        data-product-id="1"
                        data-product-name="Stripe Polo T-Shirt"
                        data-product-price="1150"
                        data-product-image="{{ asset('images/1.webp') }}">ADD TO CART
                    </button>
                </div>
            </div>
    ...
    <button id="quickview-quantity-minus-btn"
        class="quantity-minus-btn w-10 h-full text-lg text-gray-600 hover:bg-gray-100">−</button>
    <input type="text" id="quickview-quantity-input" value="1"
        class="quantity-input w-12 text-center border-l border-r border-gray-300 h-full focus:outline-none"
        readonly>
    <button id="quickview-quantity-plus-btn"
        class="quantity-plus-btn w-10 h-full text-lg text-gray-600 hover:bg-gray-100">+</button>
</div>
