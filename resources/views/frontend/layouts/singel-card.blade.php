        ...
        <div class="py-4 px-4 flex flex-col items-start justify-between relative">
            ...
            <div class="relative w-full h-6 mt-1 z-10">
                ...
                <div class="flex items-center gap-3 text-[14px] font-semibold absolute top-0 left-0 text-gray-600">
                    ...
                    <button class="wishlist-button" data-id="2" data-name="Stripe Polo T-Shirt" data-price="1150"
            ...
            <div class="product-options-modal absolute left-0 w-full bg-white p-4 shadow-xl rounded-lg z-[9999] border hidden"
                ...
                <div class="flex items-center space-x-1 xl:space-x-3 mb-4">
                    ...
                    <button
                        class="add-to-cart-btn bg-gray-800 text-gray-400 font-semibold px-5 py-2.5 rounded hover:bg-gray-800 transition-colors"
                        data-product-id="2"
                        data-product-name="Stripe Polo T-Shirt2"
                        data-product-price="1150"
                        data-product-image="{{ asset('images/2.webp') }}">ADD TO CART
                    </button>
                </div>
            </div>
        </div>
...
<div class="swiper-slide">
    <div class="product-card bg-white w-full group overflow-hidden relative ">
        <div class="relative h-[400px] w-full border overflow-hidden">
            <img src="{{ asset('images/3.webp') }}" alt="Polo T-Shirt 3"
                class="w-full h-full object-cover block min-w-[300px]">
            <span class="absolute bottom-2 left-2 bg-white text-[10px] px-2 py-0.5">New</span>
        </div>

        <div class="py-4 px-4 flex flex-col items-start justify-between relative">
            <p class="text-lg font-semibold ">Stripe Polo T-Shirt3</p>
            ...
            <div class="relative w-full h-6 mt-1 z-10">
                ...
                <div class="flex items-center gap-3 text-[14px] font-semibold absolute top-0 left-0 text-gray-600">
                    ...
                    <button class="wishlist-button" data-id="3" data-name="Stripe Polo T-Shirt3" data-price="11503"
            ...
            <div class="product-options-modal absolute left-0 w-full bg-white p-4 shadow-xl rounded-lg z-[9999] border hidden"
                ...
                <div class="flex items-center space-x-1 xl:space-x-3 mb-4">
                    ...
                    <button
                        class="add-to-cart-btn bg-gray-800 text-gray-400 font-semibold px-5 py-2.5 rounded hover:bg-gray-800 transition-colors"
                        data-product-id="3"
                        data-product-name="Stripe Polo T-Shirt3"
                        data-product-price="11503"
                        data-product-image="{{ asset('images/3.webp') }}">ADD TO CART
                    </button>
                </div>
            </div>
        </div>
