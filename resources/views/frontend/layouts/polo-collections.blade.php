<section class="polo-collections bg-white py-8 px-4 md:py-12 md:px-6 lg:px-8">
    <div class="max-w-screen-xl mx-auto relative"> {{-- Make this div relative for absolute positioning of buttons --}}
        ...
        <div class="swiper-slide">
            <div class="product-card bg-white w-full h-full group overflow-hidden">
                <!-- Image Wrapper -->
                <div class="relative">
                ...
                <div class="py-4 flex flex-col items-start justify-between">
                    <!-- Product Name -->
                    <p class="text-md font-medium text-gray-800">Stripe Polo T-Shirt</p>
                    ...
                    <div class="relative w-full h-6 mt-1">
                        ...
                        <!-- Hover Actions -->
                        <div class="flex items-center gap-3 text-[13px] font-semibold absolute top-0 left-0">
                            ...
                            <button
                                class=" border-b-2 border-black
                                                transition-all duration-300
                                                opacity-0 translate-y-full
                                                group-hover:opacity-100 group-hover:translate-y-0 group-hover:delay-[100ms] delay-[200ms]">
                                Quick&nbsp;View
                            </button>
...
<button id="polo-custom-prev"
    class=" w-16 h-10 group absolute top-1/2 left-4 -translate-y-1/2 z-20 focus:outline-none cursor-pointer flex items-center justify-center"
...
<button id="polo-custom-next"
    class=" w-16 h-10 group absolute top-1/2 right-4 -translate-y-1/2 z-20 focus:outline-none cursor-pointer flex items-center justify-center"
