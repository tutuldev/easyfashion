<section class="trending bg-white py-8 px-4">
  <div class="flex flex-col md:flex-row max-w-screen-xl gap-8 mx-auto">
    ...
    <div class="relative w-full h-[530px] group/item overflow-hidden rounded-lg shadow-lg"
          style="background-image:url('{{ asset('images/trending-1.webp') }}');background-size:cover;background-position:center;">

      <div class="absolute inset-0 bg-black/20 transition-all duration-700 ease-in-out
                   group-hover/item:opacity-0"></div>

      <div class="absolute inset-0 flex flex-col justify-between text-white p-7 md:p-20">
        <div>
          <h2 class="text-3xl md:text-5xl font-bold leading-tight">CASUAL<br>SHIRT</h2>
        </div>

        <div class="translate-x-10 opacity-0 space-y-4 transition-all duration-700 ease-in-out
    ...
    <div class="relative w-full h-[530px] group/item overflow-hidden rounded-lg shadow-lg"
          style="background-image:url('{{ asset('images/trending-2.webp') }}');background-size:cover;background-position:center;">
      ...
      <div class="absolute inset-0 flex flex-col justify-between text-white p-7 md:p-20">
        <div>
          <h2 class="text-3xl md:text-5xl font-bold leading-tight">POLO</h2>
        </div>
