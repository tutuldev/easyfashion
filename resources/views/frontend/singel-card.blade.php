...
<div class="swiper-slide">
    <div class="product-card bg-white w-full group overflow-hidden relative ">
        <div class="relative h-[400px]  w-full border overflow-hidden">
            <img src="{{ asset('images/1.webp') }}" alt="Polo T-Shirt 1" class="w-full h-full object-cover block min-w-[300px]">
        ...
        <div class="py-4 px-4 flex flex-col items-start justify-between relative">
            ...
            <div class="relative w-full h-6 mt-1 z-10">
                ...
                <div class="flex items-center gap-3 text-[14px] font-semibold absolute top-0 left-0 text-gray-600">
                    ...
                    <button class="transition-all duration-300 opacity-0 translate-y-full
                        group-hover:opacity-100 group-hover:translate-y-0 group-hover:delay-[200ms] delay-[200ms]">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-4 w-4 stroke-black fill-transparent" viewBox="0 0 24 24"
            ...
            {{-- এখানে id অ্যাট্রিবিউট সরিয়ে দেওয়া হয়েছে --}}
            <div class="product-options-modal absolute left-0 w-full bg-white p-4 shadow-xl rounded-lg z-[9999] border hidden"
                ...
                <div class="mb-4">
                    <div class="relative mt-1">
                        {{-- এখানে id অ্যাট্রিবিউট সরিয়ে দেওয়া হয়েছে --}}
                        <select class="size-option-select block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md appearance-none">
                ...
                <div class="flex items-center space-x-1 xl:space-x-3 mb-4">
                    <div class="flex border border-gray-300 rounded overflow-hidden">
                        {{-- এখানে onclick থেকে id এবং input থেকে id অ্যাট্রিবিউট সরিয়ে দেওয়া হয়েছে --}}
                    ...
                    <button class="add-to-cart-btn bg-gray-800 text-gray-400 font-semibold px-5 py-2.5 rounded hover:bg-gray-800 transition-colors">ADD TO CART</button>
                </div>
            </div>
        </div>
    </div>
