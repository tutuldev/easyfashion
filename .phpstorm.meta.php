...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\laravel-11-practice-project\easyfashion\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.E:\\laravel-11-practice-project\\easyfashion\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'profile.destroy','products.filterByCategory','categories.index','categories.create','categories.store',
'categories.show','categories.edit','categories.update','categories.destroy','products.index',
'products.create','products.store','products.show','products.edit','products.update',
'products.destroy','orders.index','orders.create','orders.store','orders.show',
'orders.edit','orders.update','orders.destroy','order','register',
...
'admin.orders.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','backend.app','backend.categories.create','backend.categories.edit',
'backend.categories.index','backend.categories.show','backend.layouts.asidebar','backend.layouts.header','backend.products.create',
'backend.products.edit','backend.products.filtered','backend.products.index','backend.products.show','cart',
'checkout','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
...
'dashboard-auth','frontend.app','frontend.layouts.banner','frontend.layouts.copyright','frontend.layouts.followus',
'frontend.layouts.footer','frontend.layouts.jins','frontend.layouts.justin','frontend.layouts.navbar','frontend.layouts.polo-collections',
'frontend.layouts.process','frontend.layouts.product-category','frontend.layouts.singel-card','frontend.layouts.social','frontend.layouts.tranding',
'frontend.layouts.video','home','layouts.app','layouts.guest','layouts.navigation',
'pagination::bootstrap-4','pagination::bootstrap-5','pagination::custom','pagination::default','pagination::semantic-ui',
...
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','vendor.pagination.bootstrap-4',
'vendor.pagination.bootstrap-5','vendor.pagination.custom','vendor.pagination.default','vendor.pagination.semantic-ui','vendor.pagination.simple-bootstrap-4',
